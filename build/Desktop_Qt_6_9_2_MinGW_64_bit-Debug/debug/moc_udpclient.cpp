...
template <> constexpr inline auto UdpClient::qt_create_metaobjectdata<qt_meta_tag_ZN9UdpClientE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'start'
        QtMocHelpers::SlotData<void(quint16)>(6, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::UShort, 7 },
        }}),
        // Slot 'sendMessage'
...
void UdpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->start((*reinterpret_cast< std::add_pointer_t<quint16>>(_a[1]))); break;
        case 4: _t->sendMessage((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (UdpClient::*)(QString )>(_a, &UdpClient::messageReceived, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (UdpClient::*)(QString )>(_a, &UdpClient::messageSent, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (UdpClient::*)()>(_a, &UdpClient::statusChanged, 2))
            return;
    }
...
// SIGNAL 0
void UdpClient::messageReceived(QString _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void UdpClient::messageSent(QString _t1)
{
